...
(function ($) {
    $.fn.fullpage = function (options) {
        ...
        if (options.verticalCentered) {
            $('.fp-section').addClass('table');
            $('.fp-section').wrapInner('<div class="tableCell" />');
        }
        ...
        $(document).keydown(function (e) {
            ...
            if (!isMoving) {
                switch (e.which) {
                    ...
                    //left
                    case 37:
                        $('.fp-section.active').find('.controlArrow.prev').trigger('click');
                        break;

                    //right
                    case 39:
                        $('.fp-section.active').find('.controlArrow.next').trigger('click');
                        break;
		 ...
		 */
        $('.fp-section').on('click', '.controlArrow', function () {
            var slides = $(this).closest('.fp-section').find('.slides');
