...
(function ($) {
    ...
    var _options = [
      ...
      ['centerIfFit', 'boolean', true],
      ['triggerScrollyeah', 'boolean', true]
    ];
    ...
    $(function () {
        ...
        //$('#stick-body').each(function () {
        //    var $this = $(this);
        //    $this.scrollyeah(collectOptions($this));
        //});
        //$('#thead-body').each(function () {
        //    var $this = $(this);
        //    $this.scrollyeah(collectOptions($this));
        //});
        //$('#boxother-result').each(function () {
        //    var $this = $(this);
        //    $this.scrollyeah(collectOptions($this));
        //});
