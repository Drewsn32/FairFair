    ...
    activate: function () {
        ...
        $(window).click(function (e) {
            ...
            if (!$target.hasClass('bars')  && _this.isOpen() && $target.parents('#leftsidebar').length === 0) {
                if (!$target.hasClass('js-right-sidebar') && !$target.hasClass('navbar-toggle')) {
                    $overlay.fadeOut();
                }
...
$.AdminBSB.navbar = {
    activate: function () {
        ...
        $(window).click(function (e) {
            var $target = $(e.target);
            if (_this.isOpen() && !$target.hasClass('navbar-collapse')) {
                $overlay.fadeOut();
                $sidebar.removeClass('in');
            }
        });
    ...
    isOpen: function () {
        return $('.navbar-collapse').hasClass('in');
    }
}
//==========================================================================================================================
